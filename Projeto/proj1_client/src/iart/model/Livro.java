...
class Livro {
    ...
    private static final int IndexIdLivro = 1;
    private static final int IndexTitulo = 2;
    private static final int IndexAutor = 3;
    private static final int IndexAno = 4;
    private static final int IndexGenero = 5;
