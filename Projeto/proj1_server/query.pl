...
filtrar_autores_mortos(Selector, AnoLimite, Genero, Lista):-
	findall(autor(IdAutor, PrimeiroNome, UltimoNome, AnoNascimento, AnoMorte, Sexo, Nacionalidade, Pseudonimos),
	(
		autor(IdAutor, PrimeiroNome, UltimoNome, AnoNascimento, AnoMorte, Genero, Nacionalidade, Pseudonimos),
		(%AnoLimite < 0 ;
		AnoMorte > 0)%,
...
filtrar_autores_aux(IdAutor,[Primeiro,Ultimo]):-
    autor(IdAutor,Primeiro,Ultimo,_,_,_,_,_).



% selecciona autores com determinada nacionalidade
filtrar_autores_aux(autor(IdAutor, PrimeiroNome, UltimoNome, AnoNascimento, AnoMorte, Sexo, Nacionalidade, Pseudonimos), [m=Sexo|Tail]):-
	filtrar_autores_aux(autor(IdAutor, PrimeiroNome, UltimoNome, AnoNascimento, AnoMorte, Sexo, Nacionalidade, Pseudonimos), Tail).
% selecciona autores com determinada nacionalidade
filtrar_autores_aux(autor(IdAutor, PrimeiroNome, UltimoNome, AnoNascimento, AnoMorte, Sexo, Nacionalidade, Pseudonimos), [f=Sexo|Tail]):-
	filtrar_autores_aux(autor(IdAutor, PrimeiroNome, UltimoNome, AnoNascimento, AnoMorte, Sexo, Nacionalidade, Pseudonimos), Tail).
